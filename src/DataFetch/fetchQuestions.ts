export const allQuestionsArr: { question: string; answer: string }[] = [
	...
	},
	{
		...
		answer:
			"Jeśli zostanie stwierdzona wada produktu, przysługuje Ci prawo do wniesienia reklamacji. Reklamację należy zgłosić w terminie 7 dni od dnia wykrycia wady.",
	},
	{
		question: "Jaki jest czas oczekiwania na darmowe próbki?",
		answer: "Około 5 dni roboczych.",
	},
	{
