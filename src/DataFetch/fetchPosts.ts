...
import Blog5_1 from "../assets/Blog/Article5img.png"
import Article5 from "../components/BlogComponents/Article5"

import Blog6_1 from "../assets/Blog/Article6.jpg"
import Article6 from "../components/BlogComponents/Article6"

import Blog7_1 from "../assets/Blog/Article7.jpg"
import Article7 from "../components/BlogComponents/Article7"

import Blog8_1 from "../assets/Blog/Article8.jpg"
import Article8 from "../components/BlogComponents/Article8"
...
export const posts = [
	...
	{
		id: 5,
		title: "Odzież firmowa na zamówienie",
		url: "odziez-firmowa-na-zamowienie",
		img: Blog5_1,
		alt: "Odzież firmowa na zamówienie - bluzlo.pl",
		metaDesc:
			"Profesjonalna i stylowa odzież firmowa na zamówienie dostosowana do Twojej marki. Zadbaj o wizerunek swojego zespołu. Napisz do nas!",
		component: Article5,
	},
	{
		id: 6,
		title: "Bluzy firmowe z nadrukiem",
		url: "bluzy-firmowe-z-nadrukiem",
		img: Blog6_1,
		alt: "Bluzy firmowe z nadrukiem - bluzlo.pl",
		metaDesc:
			"Najwyższej jakości bluzy firmowe z personalizowanym nadrukiem. Stylowe i wygodne propozycje dla Twojego zespołu lub wydarzenia. Zaprojektuj własną bluzę już teraz. Napisz do nas!",
		component: Article6,
	},
	{
		id: 7,
		title: "Merch firmowy na zamówienie",
		url: "merch-firmowy-na-zamowienie",
		img: Blog7_1,
		alt: "Merch firmowy na zamówienie - bluzlo.pl",
		metaDesc:
			"Merch firmowy na zamówienie. Zainwestuj w niesamowitą atmosferę w zespole, która podniesie wyniki w Twojej firmie. Napisz do nas, a chętnie Ci pomożemy!",
		component: Article7,
	},
	{
		id: 8,
		title: "Ubrania firmowe z logo",
		url: "ubrania-firmowe-z-logo",
		img: Blog8_1,
		alt: "Ubrania firmowe z logo - bluzlo.pl",
		metaDesc:
			"Ubrania firmowe z logo dla Twojego zespołu. Zadbaj o atmosferę i zainwestuj w odzież firmową. W bluzlo zajmiemy się wszystkim i dostosujemy pod każde zlecenie.",
		component: Article8,
	},
]
